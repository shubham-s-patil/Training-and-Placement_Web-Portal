...
$sql = "SELECT tblleaves.id as lid,student.name,student.grno,student.id,student.gender,student.mob,student.email,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join student on tblleaves.empid=student.id where tblleaves.id=:lid";
$query = $dbh -> prepare($sql);
