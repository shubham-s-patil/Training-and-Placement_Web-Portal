					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed sidemenu-hover-submenu" data-keep-expanded="false" data-auto-scroll="true"
						 data-slide-speed="200" style="padding-top: 20px">
							...
							<li class="nav-item">
								<a href="Registered_students.php" class="nav-link nav-toggle"> <i class="material-icons">group</i>
									<span class="title">Registered students</span> <span class="arrow"></span>
								</a>
							</li>
							<li class="nav-item">
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="calendar.php">Calendar</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
