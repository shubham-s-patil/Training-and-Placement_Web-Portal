				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Faculty Providing Training to Industry</div>
							</div>
...
try {
    ...
    $stmt = $conn->prepare("SELECT facultyname, department, datefrom, dateto, days, compname, attended FROM faculty_training "); 
    $stmt->execute();
