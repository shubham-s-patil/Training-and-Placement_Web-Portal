				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Faculty Internship,Workshop</div>
							</div>
...
try {
    ...
    $stmt = $conn->prepare("SELECT facultyname, department, datefrom, dateto, days, compname,title FROM facultyintern "); 
    $stmt->execute();
