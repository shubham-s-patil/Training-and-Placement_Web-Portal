...
$eid=$_SESSION['elogin'];
$sql = "SELECT tblleaves.id as lid,student.UserPic,tblleaves.comp_name,tblleaves.academicyear,student.year,student.mob,student.email,student.rollno,student.department,student.name,student.grno,student.id,tblleaves.LeaveType,tblleaves.vtype,tblleaves.ToDate,tblleaves.FromDate,tblleaves.PostingDate,tblleaves.Status from tblleaves join student on tblleaves.grno=student.grno where tblleaves.id=$lid";
									...
									<div class="col-md-12">
											...
											<address>
												...
												<p class="addr-font-h4">Viswakarma Institute Of Information Technology<br>
												         Department Of <?php echo htmlentities($result->department);?> Engineering</p><br>
						...
						<div class="col-sm-12">
								<div class="card-body row">
									...
									<div class="col-lg-5 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" value="<?php echo htmlentities($result->mob);?>" id="txtstdcapacity">
										...
										<div class="pull-right text-right">
											<address><center>
												<p class="addr-font-h4">
													<br><br><br><br>  Yours Faithfully,<br><br> (Signature Of Student)
												</p></center>
											</address>
										</div>
										<div class="pull-left">
											<address>
												<p class="addr-font-h4">
													<br><br><br><br> Date : <?php echo htmlentities($result->PostingDate);?>
