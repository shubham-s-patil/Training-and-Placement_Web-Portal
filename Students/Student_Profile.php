...
$dob1=$_POST['dob']; 
$sql="update student set name=:name1,grno=:grno1,email=:email1,address=:address1,department=:department1,division=:division1,year=:year1,mob=:mob1,gender=:gender1,dob=:dob1 where grno=:eid";
$query = $dbh->prepare($sql);
$query->bindParam(':name1',$name1,PDO::PARAM_STR);
$query->bindParam(':grno1',$grno1,PDO::PARAM_STR);
...
$query->bindParam(':division1',$division1,PDO::PARAM_STR);
...
{               ?> 
					 ...
					 <!-- start manage user dropdown -->
						<li class="dropdown dropdown-user">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
								<img alt="" class="img-circle " src="userimages/<?php echo htmlentities($result->UserPic);?>" />
								...
								<div class="card card-topline-aqua">
									<div class="card-body no-padding height-9">
										...
										<form id="example-form" method="post" name="updatemp">
												...
												<img src="userimages/<?php echo htmlentities($result->UserPic);?>" class="img-responsive" alt=""> </div>
										</div>
												...
												<div class="tab-pane active fontawesome-demo" id="tab1">
													<div id="biography">
														<div class="row">
															...
															<div class="col-md-3 col-6 b-r"> <strong>Gr No.</strong>
																<br>
                                                                <input  name="grno" id="grno" value="<?php echo htmlentities($result->grno);?>" type="text" autocomplete="off" readonly required>
															</div>
  ...
  <strong>Department  </strong>           
   ...
   <select id="department" name="department" type="tel" value="<?php echo htmlentities($result->department);?>" maxlength="10" autocomplete="off" readonly required> 
   ...
   <option>IT</option>	
															...
															<div class="col-md-3 col-6 b-r"> <strong>Division</strong>
																<br>
																<input id="division" name="division" type="tel" value="<?php echo htmlentities($result->division);?>" maxlength="10" autocomplete="off" required>

															</div>
															<div class="col-md-3 col-6 b-r"> <strong>Year</strong>
																<br>
																<input id="year" name="year" type="tel" value="<?php echo htmlentities($result->year);?>" maxlength="10" autocomplete="off" required>
...
try {
	...
	$eid=$_SESSION['elogin'];
    $stmt = $conn->prepare("SELECT comp_name,address,city,days,skill,mname,fname,mmob FROM internship where grno=:eid"); 
