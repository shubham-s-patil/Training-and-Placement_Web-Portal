					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed sidemenu-hover-submenu" data-keep-expanded="false" data-auto-scroll="true"
						 data-slide-speed="200" style="padding-top: 20px">
							...
							<li class="nav-item">
								<a href="Student_Profile.php" class="nav-link nav-toggle"> <i class="material-icons">person</i>
							...
							<li class="nav-item">
								<a href="logout.php" class="nav-link nav-toggle"> <i class="material-icons">business</i>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									<header>Placements</header>
								</div>
								<div class="card-body" id="bar-parent">
									<form action="db/db_placement.php" method="POST" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="rollno" placeholder="enter Roll No." class="form-control input-height" />
												</div>
											</div>
											
											<div class="form-group row">
												<label class="control-label col-md-3">GR No.
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="grno" placeholder="enter GR No." class="form-control input-height" />
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="name" placeholder="enter student name" class="form-control input-height" />
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<select class="form-control input-height" name="shift">
														<option value="">Select...</option>
														<option>I</option>
														<option>II</option>
													</select>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="comp_name" placeholder="enter company name with address" class="form-control input-height" />
												</div>
											</div>
											
																
											<div class="form-group row">
												<label class="control-label col-md-3">Annual Package
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="package" placeholder="enter annual package" class="form-control input-height" />
												</div>
											</div>
