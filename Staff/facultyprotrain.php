...
<head>
	...
	<title>Faculty Providing Training to Industry</title>
	<!-- google font -->
				...
				<div class="page-content">
					<div class="page-bar">
						...
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Faculty providing training </div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Faculty providing training </li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									<header>Faculty providing training to industry</header>
								</div>
								<div class="card-body" id="bar-parent">
									<form action="db/db_facultypro.php" method="POST" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
										...
										<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="facultyname" placeholder="enter faculty name" class="form-control input-height" />
												</div>
											</div>
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Date From
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">No. of Industry persons attended
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="attended" placeholder="enter no. of industry persons attended" class="form-control input-height" />
												</div>
											</div>
