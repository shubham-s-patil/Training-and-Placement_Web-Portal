...
<head>
	...
	<title>Approved Internships</title>
	<!-- google font -->
				...
				<div class="page-content">
					<div class="page-bar">
						...
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Approved Internships</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Approved Internships</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									<header>Approved Internships</header>
								</div>
...
try {
	...
	$status=1;
    $stmt = $conn->prepare( "SELECT grno,comp_name,LeaveType,address,city,AdminRemarkDate from tblleaves where tblleaves.Status=:status"); 
