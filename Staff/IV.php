				...
				<div class="page-content">
					<div class="page-bar">
						...
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Industrial Visit</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Industrial Visit</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									<header>Industrial Visit</header>
								</div>
								<div class="card-body" id="bar-parent">
									<form action="db/db_visit.php" method="POST" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
										...
										<div class="form-group row">
												<label class="control-label col-md-3">Visit Duration
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<div class="date" data-date-format="dd MM yyyy">
														<input name="datefrom" class="form-control input-height" size="16" placeholder="From..." type="date" value="">					
													</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<div class="date" data-date-format="dd MM yyyy">
														<input name="dateto" class="form-control input-height" size="16" placeholder="To..." type="date" value="">					
													</div>
													<input type="hidden" id="dtp_input5" value="" />
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="days" placeholder="enter no. of days" class="form-control input-height" />
												</div>
											</div>
											
											<div class="form-group row">
												<label class="control-label col-md-3">No. of Students
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="students" placeholder="enter no. of students" class="form-control input-height" />
												</div>
											</div>
											
											<div class="form-group row">
												<label class="control-label col-md-3">No. of Faculties
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="faculties" placeholder="enter no. of faculties" class="form-control input-height" />
												</div>
											</div>
											
											
											<div class="form-group row">
												<label class="control-label col-md-3">Faculty Coordinator
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="Coordinator" placeholder="enter faculty coordinator" class="form-control input-height" />
												</div>
											</div>
