...
<head>
	...
	<title>Faculty Internships</title>
	<!-- google font -->
			...
			<div class="page-content-wrapper">
				...
				<div class="page-bar">
						...
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Faculty Internships</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Faculty Internships</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									<header>Faculty Internships</header>
								</div>
							
								<div class="card-body" id="bar-parent">
									<form action="db/db_facultyintern.php" method="POST" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Title of Internship
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="title" placeholder="enter title of internship" class="form-control input-height" />
												</div>
											</div>
