...
$sql="INSERT INTO company(companyname,type,skills,address,deadline) VALUES(:companyname,:type,:skills,:address,:deadline)";
									...
									<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
										...
										<div class="form-body">
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="companyname" placeholder="Enter company name" class="form-control input-height" />
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">SkillSets Required
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="skills" placeholder="skills" class="form-control input-height" />
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-md-5">
													<div class="date " data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input5"
													 data-link-format="yyyy-mm-dd">
														<input name="deadline" value="" class="form-control input-height" type="date" >
