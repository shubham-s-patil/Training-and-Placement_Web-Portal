...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Internship Details </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="font-size:24px;">Internship Details</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Internship Details</span>
...
$sql = "SELECT tblleaves.id as lid,student.name,student.grno,student.id,tblleaves.comp_name,student.gender,student.mob,student.email,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate,tblleaves.mname,tblleaves.mmob,tblleaves.memail,tblleaves.fname,tblleaves.fmob,tblleaves.femail from tblleaves join student on tblleaves.grno=student.grno where tblleaves.id=:lid";
$query = $dbh -> prepare($sql);
$eid=$_SESSION['elogin'];
$ret=mysqli_query($conn,"select certificate from tbldocument where UserID='$eid'");
...
{         
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Name :</b></td>
                                              ...
                                              <td style="font-size:16px;"><b>Gr No :</b></td>
                                              <td><?php echo htmlentities($result->grno);?></td>
  ...
  <tr>
                                             <td style="font-size:16px;"><b>Internship Type :</b></td>
                                            <td><?php echo htmlentities($result->LeaveType);?></td>
                                             <td style="font-size:16px;"><b>Internship Period . :</b></td>
...
<tr>
                                             <td style="font-size:16px;"><b>Internship Description : </b></td>
                                            <td><?php echo htmlentities($result->Description);?></td>
											<td style="font-size:16px;"><b>Mentor Name: </b></td>
                                            <td><?php echo htmlentities($result->mname);?></td>
											<td style="font-size:16px;"><b>Mentor Mob No: </b></td>
                                            <td><?php echo htmlentities($result->mmob);?></td>
...
<td style="font-size:16px;"><b>Mentor Email: </b></td>
