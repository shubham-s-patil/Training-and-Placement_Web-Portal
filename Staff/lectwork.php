...
<head>
	...
	<title>Lecture Workshop Organized</title>
	<!-- google font -->
				...
				<div class="page-content">
					<div class="page-bar">
						...
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Lectures, Workshop Organized</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Lectures, Workshop Organized</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									<header>Lectures, Workshop Organized</header>
								</div>
								<div class="card-body" id="bar-parent">
									<form action="db/db_lectwork.php" method="POST" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<select class="form-control input-height" name="year">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Organized For
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<select class="form-control input-height" name="organize">
														<option value="">Select...</option>
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Company name with address
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="compname" placeholder="enter company name with address" class="form-control input-height" />
												</div>
											</div>
											
																						
											<div class="form-group row">
												<label class="control-label col-md-3">Trainer name
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="trainer" placeholder="enter trainer name" class="form-control input-height" />
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="designation" placeholder="enter designation" class="form-control input-height" />
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="topic" placeholder="enter topic" class="form-control input-height" />
												</div>
											</div>
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Date Of Lecture/Workshop
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<div class="date" data-date-format="dd MM yyyy">
														<input name="date_" class="form-control input-height" size="16" placeholder="Date of lecture/workshop" type="date" value="">					
													</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="class" placeholder="enter class" class="form-control input-height" />
												</div>
											</div>
											
											<div class="form-group row">
												<label class="control-label col-md-3">No. of Faculties/ Students attended
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="attendance" placeholder="enter no. of faculties/students attended" class="form-control input-height" />
												</div>
											</div>
