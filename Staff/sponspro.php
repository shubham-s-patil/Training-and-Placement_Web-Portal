			...
			<div class="page-content-wrapper">
				<div class="page-content">
						...
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Sponsored Projects</div>
							</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									<header>Sponsored Projects</header>
								</div>
								<div class="card-body" id="bar-parent">
									<form action="db/db_sponspro.php" method="POST" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Industry name with address
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="industry_name" placeholder="enter industry name with address" class="form-control input-height" />
												</div>
											</div>
											
											<div class="form-group row">
												<label class="control-label col-md-3">Program (UG/PG)
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="program" placeholder="enter program (UG/PG)" class="form-control input-height" />
												</div>
											</div>
											
											
											<div class="form-group row">
												<label class="control-label col-md-3">Project Domain
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="projdomain" placeholder="enter project domain" class="form-control input-height" />
												</div>
											</div>
											
									
											<div class="form-group row">
												<label class="control-label col-md-3">No. of Projects
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<input type="text" name="noofproj" placeholder="enter no. of projects" class="form-control input-height" />
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="noofstud" placeholder="enter no. of students" class="form-control input-height" />
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="nooffaculty" placeholder="enter no. of faculties" class="form-control input-height" />
												</div>
											</div>
